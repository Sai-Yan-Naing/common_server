...
# PHP設定
#Add-WebConfiguration /system.webServer/fastCGI -value @{fullPath="C:\PHP7.4.15\php-cgi.exe";arguments="-d open_basedir=E:\webroot\LocalUser\${USER_NAME}"}
#$PHP_Handler = 'C:\PHP7.4.15\php-cgi.exe|-d open_basedir=E:\webroot\LocalUser\'+${USER_NAME}
...
Add-WebConfiguration /system.webServer/fastCGI -value @{fullPath="C:\PHP7.4.15\php-cgi.exe";arguments="-d open_basedir=E:\webroot\LocalUser\${USER_NAME}"}
$PHP_Handler = 'C:\PHP7.4.15\php-cgi.exe|-d open_basedir=E:\webroot\LocalUser\'+${USER_NAME}
Add-Webconfiguration -filter /system.webServer/handlers -location $USER_NAME -pspath "IIS:" -value @{name='PHP7.4.15-nts-x64_via_FastCGI';path='*.php';verb='*';modules='FastCgiModule';scriptProcessor=$PHP_Handler}
