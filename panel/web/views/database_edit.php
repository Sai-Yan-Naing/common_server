...
<div class="modal-body">
                ...
                <form action="database_con.php" method="post" id="database_edit">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="username" readonly name="db_username" value="<?= $getdata['db_user'] ?>" placeholder="8～70文字、半角英数記号の組み合わせ">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="db_password" class="col-sm-4 col-form-label">パスワード</label>
                        <div class="col-sm-8">
                          <input type="password" class="form-control" id="db_password" value="<?= $getdata['pass'] ?>" name="db_password" placeholder="8～70文字、半角英数記号の組み合わせ">
