...
<div class="modal-body">
	...
	<form action="database_con.php" method="post" id="delete_database">
		<input type="hidden" name="type" value="<?php echo $_POST['db']; ?>">
		<input type="hidden" name="action" value="delete">
		<input type="hidden" name="id" value="<?= $getdata['id'] ?>">
		<input type="hidden" name="db_username" value="<?= $getdata['db_user'] ?>">
		<input type="hidden" name="db_password" value="<?= $getdata['pass'] ?>">
