...
<div class="modal-body">
	...
	<form action="mail_setting_confirm.php" method="post" id="email_create">
		<input type="hidden" name="type" value="new">
    	<div class="form-group row mr-2 justify-content-center">
    		<label for="email" class="col-sm-3">メールアドレス</label>
		    <input type="text" class="form-control col-sm-6" placeholder="メールアドレス" onkeyup="change_mail_text(this.value)" id="email" name="email">
		    <label  class="col-sm-3 form-label"  for="email"><span id="change_mail_text"></span>@<?= $_COOKIE['d']?></label>
