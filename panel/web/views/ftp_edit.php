...
<div class="modal-body">
	...
	<form action="ftp_confirm.php" method="post" id="ftp_edit">
		<input type="hidden" name="type" value="edit">
		<input type="hidden" name="id" value="<?= $_POST['edit_id'] ?>">
	    <div class="form-group row">
	        <label for="ftpuser" class="col-sm-4 col-form-label">FTPユーザー</label>
	        <div class="col-sm-8">
	          <input type="text" class="form-control" readonly value="<?= $ftp['username'] ?>" name="ftpuser" placeholder="1-14文字、半角英数字">
	        </div>
	    </div>
	    <div class="form-group row">
	        <label for="ftp_pass_word" class="col-sm-4 col-form-label">パスワード</label>
	        <div class="col-sm-8">
	          <input type="password" class="form-control" id="ftp_pass_word" name="ftp_pass_word" value="<?= $ftp['password'] ?>" placeholder="8～70文字、半角英数記号の組み合わせ">
