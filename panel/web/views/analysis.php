...
<!-- Start of Wrapper  -->
    <div class="wrapper">
        ...
        <div id="content" class="dhome"  style="margin-top: 80px;">
            ...
            <div class="col-sm-9">
                <div style="font-size: 30px;">Winserver Controlpanel Share server</div>
                <div class="analysis">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-4">
                        ...
                        <div style="border: 2px solid grey;">
                            <div class="row">
                                <div class="col-4 p-0">
                                    <div class="text-center mt-2 mb-2 pt-3 pb-3" style="border-right: 1px solid grey;"><i class="fas fa-desktop"></i></div>
                                </div>
                                <div class="col-4 p-0">
                                    <div class="text-center mt-2 mb-2 pt-3 pb-3" style="border-right: 1px solid grey;"><i class="fas fa-mobile-alt"></i></div>
                                </div>
                                <div class="col-4 p-0">
