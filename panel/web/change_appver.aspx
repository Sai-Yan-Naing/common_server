...
{
	string version = Request.Form.Get("v");
	
	if (string.Compare(version, "v2.0") == 0) {
		version = "v2.0";
	} else {
		version = "v4.0";
	}
    ...
    // 引数
    p.StartInfo.Arguments = @"set apppool /apppool.name:" + user + @" /managedRuntimeVersion:" + version;
...
<% Response.Redirect("~/app_list.aspx?is_ver=1"); %>
