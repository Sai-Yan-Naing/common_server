...
php add_db.php $Args[0] $Args[1] $Args[2] 3
...
# クオータの設定
fsutil quota modify E: 214748364800 214748364800 $USER_NAME
...
#python設定
$PY_Handler = 'C:\Python27\python.exe %s %s'
Add-Webconfiguration -filter /system.webServer/handlers -location $USER_NAME -pspath "IIS:" -value @{name='PYTHON_VIA_CGI';path='*.py';verb='*';modules='CgiModule';scriptProcessor=$PY_Handler}
